    ...
    <main className="main-content">
      <div className="container">
        ...
        <section className="content-section">
          ...
          <p>
            En el siglo XX, Lewis Terman y Leta Hollingworth estudiaron a niños superdotados en Estados Unidos. Sus trabajos marcaron un avance, pero se centraron en varones jóvenes con logros escolares, dejando fuera a mujeres, adultos y perfiles menos convencionales. Esto limitó la comprensión de la <a href="/tests#el-objetivo-es-entenderte-no-validarte">neurodivergencia</a> hasta finales del siglo XX.
          </p>
          <p>
            Hoy, las ACI abarcan más que un CI alto: incluyen creatividad, intensidad emocional y asincronía (<a href="/#que-son-las-altas-capacidades-intelectuales">ver más en Home</a>). Aun así, el mito del "niño genio" persiste, descartando a quienes no encajan en ese molde.
          </p>
          <p>
            <a href="/arquetipos">¿Te suena? Mirá los arquetipos</a>
          </p>
        </section>
        ...
        <section className="content-section">
          ...
          <p>
            A los 8 años, Benjamín Equiza leía con fluidez, escribía con claridad y resolvía cálculos complejos. Sin embargo, la Dirección General de Escuelas de Buenos Aires lo obligó a repetir un año por no ajustarse a las normas de edad. Su familia impulsó la <a href="/legislacion#la-historia-de-benjamin">Ley Benjamín</a>, un proyecto para garantizar la detección temprana y el acompañamiento de estudiantes con ACI en la provincia.
          </p>
          <p>
            Este caso reflejó la dificultad de los sistemas educativos para adaptarse a la <a href="/tests#el-objetivo-es-entenderte-no-validarte">diversidad cognitiva</a>.
          </p>
        </section>
        ...
        <section className="content-section">
          ...
          <p>
            <a href="/tests#tu-sospecha-es-valida">¿Tu sospecha es válida? Empezá por Tests</a>
          </p>
        </section>
        ...
        <section className="content-section">
          ...
          <p>
            Entender tu diferencia requiere contexto. Saber cómo las ACI han sido vistas —o ignoradas— no es solo historia: es una herramienta para comprender tu propio recorrido (<a href="/arquetipos">mirá Arquetipos</a>). Ese contexto puede guiarte hacia decisiones más conscientes sobre cómo habitar tu mente.
          </p>
          <p>
            <a href="/profesionales">Buscá orientación en Profesionales si querés avanzar</a>
          </p>
        </section>
