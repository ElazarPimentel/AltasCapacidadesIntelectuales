import { curiosidadesMetadata } from '@/lib/page-metadata';
import { Metadata } from 'next';

export const metadata: Metadata = curiosidadesMetadata;
    ...
    <main className="main-content">
      <div className="container">
        ...
        <section className="content-section">
          <h2>Referencias</h2>
          <ul className="content-list">
            <li id="ref-1"><a href="https://www.britannica.com/biography/Galileo-Galilei" target="_blank" rel="noopener noreferrer">Galileo Galilei - Encyclopædia Britannica</a></li>
            <li id="ref-2"><a href="https://www.oxfordreference.com/view/10.1093/oi/authority.20110803095458976" target="_blank" rel="noopener noreferrer">Berlin, I. (1953) - The Hedgehog and the Fox</a></li>
            <li id="ref-3"><a href="https://www.maa.org/sites/default/files/pdf/devlin/LockhartsLament.pdf" target="_blank" rel="noopener noreferrer">Lockhart, P. (2002) - A Mathematician's Lament</a></li>
          </ul>
        </section>
      </div>
    </main>
