  ...
  return (
    <main className="main-content">
      <div className="container">
        ...
        <section className="tests__section">
          <h2>Persona no ACI con alto desempeño</h2>
          <p >
        ...
        <section className="tests__section">
          <h2>Persona ACI adaptada y funcional</h2>
          <p >
        ...
        <section className="tests__section">
          <h2>Persona no ACI con vida difícil</h2>
          <p >
        ...
        <section className="tests__section">
          <h2>Persona ACI con baja integración personal</h2>
          <p >
          ...
          <ul className="tests__list">
            ...
            <li><strong>⚠️ Riesgo:</strong> encerrarse en su cabeza y resignarse a la disfunción.</li>
          </ul>
        </section>
      </div>
    </main>
