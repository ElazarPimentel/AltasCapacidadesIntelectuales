...
export const metadata = generateMetadata({
  ...
  description: "Artículos y recursos especializados sobre Altas Capacidades Intelectuales en Argentina, con guías y análisis detallados.",
  path: "/articulos",
  type: "article",
});
...
<p>- Una, la identificación de ACI requiere un potencial cognitivo general medible mediante un Cociente Intelectual (CI) igual o superior a 120 (percentil 90 o más), combinado con al menos una característica excepcional observable, como la creatividad, el compromiso sostenido con la tarea o logros sobresalientes en alguna área.</p>

<p>- Y al mismo tiempo: Talentos específicos en áreas como artes, deportes o liderazgo.</p>
