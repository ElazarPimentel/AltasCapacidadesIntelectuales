    ...
    <main className="main-content">
      <div className="container">
        ...
        <section className={`content-section ${getSectionVariant(8)}`}>
          ...
          <p>
            <Link href="/#como-se-si-podria-tener-aci">¿Te identificás con esto? Leé más en la sección Home</Link>
          </p>
        </section>
        ...
        <section className={`content-section ${getSectionVariant(10)}`}>
          ...
          <p>
            <Link href="/profesionales#por-que-especializado">Conocé por qué es importante un profesional especializado</Link>
          </p>
        </section>
