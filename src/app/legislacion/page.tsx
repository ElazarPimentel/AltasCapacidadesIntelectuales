    ...
    <main className="main-content">
      <div className="container">
        ...
        <section className="content-section">
          ...
          <p>
            <a href="/tests#la-verdadera-evaluacion-es-un-proceso">¿Cómo funciona una evaluación integral?</a>
          </p>
        </section>
        ...
        <section className="content-section">
          ...
          <p>
            Otros países, como España, cuentan con leyes autonómicas específicas para ACI. Ese modelo inspiró parte de la propuesta de la Ley Benjamín (<a href="/historia#de-platon-al-test-de-ci">ver contexto histórico</a>).
          </p>
        </section>
